...
class GameMgr {
  ...
  private onKeyDown(e: KeyboardEvent) {
    ...
    switch(key) {
      case 'w':
      case 'arrowtop':
        if (snake.dir !== Direction.bottom) snake.dir = Direction.top
        break
      case 's':
      case 'arrowdown':
        if (snake.dir !== Direction.top) snake.dir = Direction.bottom
        break
      case 'a':
      case 'arrowleft':
